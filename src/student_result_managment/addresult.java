    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String dbms=jTextField6.getText();
           ...
           try{
            ...
            ResultSet res=st.executeQuery("select * from student where roll_no='"+roll+"'");
            
           if(res.next()){
            st.executeUpdate("insert into result(roll_no,physics,maths,em,os,dbms) values('"+roll+"','"+physics+"','"+maths+"','"+em+"','"+os+"','"+dbms+"')");
           }else{
           JOptionPane.showInputDialog(null, "roll number is invalid");
           }
